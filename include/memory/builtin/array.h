...
MINT_EXPORT SharedReference array_get_item(Array::values_type::iterator &it);
MINT_EXPORT SharedReference array_get_item(Array::values_type::value_type &value);
MINT_EXPORT size_t array_index(const Array *array, intmax_t index);
MINT_EXPORT WeakReference array_item(const SharedReference &item);
