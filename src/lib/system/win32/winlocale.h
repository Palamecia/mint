...
enum {
  ...
  ABDAY_1 = _NL_ITEM (MSVCRT_LC_TIME, 0), /* Sun */
...
# define ALTMON_12                __ALTMON_12
  ...
  _NL_COLLATE_NRULES = _NL_ITEM (MSVCRT_LC_COLLATE, 0),
  ...
  /* LC_CTYPE category: character classification.
	 ...
	 These `nl_langinfo' names are used only internally.  */
  _NL_CTYPE_CLASS = _NL_ITEM (MSVCRT_LC_CTYPE, 0),
  _NL_CTYPE_TOUPPER,
  _NL_CTYPE_GAP1,
  _NL_CTYPE_TOLOWER,
  _NL_CTYPE_GAP2,
...
#define CODESET                        CODESET
  ...
  /* LC_MONETARY category: formatting of monetary quantities.
	 ...
	 defined in <locale.h>.  */
  __INT_CURR_SYMBOL = _NL_ITEM (MSVCRT_LC_MONETARY, 0),
#ifdef __USE_GNU
...
# define INT_N_SIGN_POSN        __INT_N_SIGN_POSN
  ...
  __DECIMAL_POINT = _NL_ITEM (MSVCRT_LC_NUMERIC, 0),
#ifdef __USE_GNU
...
#if 0
  __YESEXPR = _NL_ITEM (MSVCRT_LC_MESSAGES, 0), /* Regex matching ``yes'' input.  */
...
# define NOSTR                        __NOSTR
  ...
  _NL_NUM_LC_MESSAGES,
  _NL_PAPER_HEIGHT = _NL_ITEM (MSVCRT_LC_PAPER, 0),
  _NL_PAPER_WIDTH,
  _NL_PAPER_CODESET,
  _NL_NUM_LC_PAPER,
  _NL_NAME_NAME_FMT = _NL_ITEM (MSVCRT_LC_NAME, 0),
  _NL_NAME_NAME_GEN,
  _NL_NAME_NAME_MR,
  _NL_NAME_NAME_MRS,
  _NL_NAME_NAME_MISS,
  ...
  _NL_NAME_CODESET,
  _NL_NUM_LC_NAME,
  _NL_ADDRESS_POSTAL_FMT = _NL_ITEM (MSVCRT_LC_ADDRESS, 0),
  ...
  _NL_ADDRESS_CODESET,
  _NL_NUM_LC_ADDRESS,
  _NL_TELEPHONE_TEL_INT_FMT = _NL_ITEM (MSVCRT_LC_TELEPHONE, 0),
  _NL_TELEPHONE_TEL_DOM_FMT,
  _NL_TELEPHONE_INT_SELECT,
  _NL_TELEPHONE_INT_PREFIX,
  _NL_TELEPHONE_CODESET,
  _NL_NUM_LC_TELEPHONE,
  _NL_MEASUREMENT_MEASUREMENT = _NL_ITEM (MSVCRT_LC_MEASUREMENT, 0),
  _NL_MEASUREMENT_CODESET,
  _NL_NUM_LC_MEASUREMENT,
  _NL_IDENTIFICATION_TITLE = _NL_ITEM (MSVCRT_LC_IDENTIFICATION, 0),
...
void CDECL MSVCRT__free_locale(MSVCRT__locale_t);
